...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.goForward = function(autoplay, callback) {
			base.gotoPage(base.currentPage + o.changeBy * (o.playRtl ? -1 : 1), autoplay, callback);
		};

		base.goBack = function(autoplay, callback) {
			base.gotoPage(base.currentPage + o.changeBy * (o.playRtl ? 1 : -1), autoplay, callback);
		};
